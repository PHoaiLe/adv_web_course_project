...
function ResetPasswordForm({ProvidedEmail})
{
    ...
    return(
        <>
            <div className="md:container md:mx-auto h-svh px-4 w-100 bg-violet-500 rounded-lg mt-10 mb-10 ">
                <form className="md:max-w-96 md:max-h-lg mx-auto mt-10 mb-10 bg-white p-8 rounded-md shadow-md" action={handleResetPasswordSubmition}>

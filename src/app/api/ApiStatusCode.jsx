...
export const ApiStatusCodes = 
{
    ...
    TEACHER_GET_INVITATION_OF_CLASS_SUCCESS: Number.parseInt(process.env.TEACHER_GET_INVITATION_OF_CLASS_SUCCESS, 10),
    TEACHER_CREATE_GRADE_COMPOSITION_SUCCESS: Number.parseInt(process.env.TEACHER_CREATE_GRADE_COMPOSITION_SUCCESS, 10),
    TEACHER_UPADTE_GRADE_COMPOSITION_SUCCESS: Number.parseInt(process.env.TEACHER_UPADTE_GRADE_COMPOSITION_SUCCESS, 10),
    TEACHER_GET_CURRENT_GRADE_STRUCTURE_SUCCESS: Number.parseInt(process.env.TEACHER_GET_CURRENT_GRADE_STRUCTURE_SUCCESS, 10),
    TEACHER_DELETE_GRADE_STRUCTURE_SUCCESS: Number.parseInt(process.env.TEACHER_DELETE_GRADE_STRUCTURE_SUCCESS, 10),
    TEACHER_SWAP_GRADE_COMPOSITION_SUCCESS: Number.parseInt(process.env.TEACHER_SWAP_GRADE_COMPOSITION_SUCCESS, 10),
